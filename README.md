# Kargo Etiketi – WooCommerce Eklentisi

[![Version](https://img.shields.io/badge/version-1.1.0-blue)](https://github.com/LionPasha/WP-Kargo-Etiket-Yazd-r)
...
| Özellik | Detay |
|---|---|
| Sipariş listesi butonu | Her satırda 🖨️ yazdır ikonu |
...
| Etiket boyutu | A6 / A5 / Termal 100×150mm |
...
### ZIP ile (önerilen)
1. [Releases](https://github.com/LionPasha/WP-Kargo-Etiket-Yazd-r/releases) sayfasından `kargo-etiketi.zip` indir.
...
```bash
# Repoyu klon'la
git clone https://github.com/LionPasha/WP-Kargo-Etiket-Yazd-r.git

# WordPress plugins klasörüne kopyala
...
### 2. Etiket Yazdır
- Sipariş listesindeki 🖨️ butonuna tıkla
- Veya sipariş detayındaki "Kargo Etiketi Yazdır" butonunu kullan
- Yeni sekmede etiketi gördükten sonra **Ctrl+P** → A6 kağıt seç
...
- Print CSS düzeltmesi (ürünler bölümü A6'da kesilmiyordu)
